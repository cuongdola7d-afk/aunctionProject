...
public class AuctionEvent {
    ...
    public AuctionEvent(AuctionEventType type, String auctionId, String itemId, String itemName,
                        String bidderName, double bidAmount, double currentPrice,
                        AuctionStatus status, LocalDateTime eventTime, String message) {
        this.type = type;
    ...
    public static AuctionEvent auctionStarted(Auction auction) {
        return baseEvent(AuctionEventType.AUCTION_STARTED, auction, null, "Auction started");
    }
    ...
    public static AuctionEvent auctionFinished(Auction auction) {
        return baseEvent(AuctionEventType.AUCTION_FINISHED, auction, null, "Auction finished");
    }

    public static AuctionEvent auctionCANCELLED(Auction auction) {
        return baseEvent(AuctionEventType.AUCTION_CANCELLED, auction, null, "Auction CANCELLED");
    }

    public static AuctionEvent statusChanged(Auction auction, AuctionStatus oldStatus, AuctionStatus newStatus) {
        return new AuctionEvent(
    ...
    private static AuctionEvent baseEvent(AuctionEventType type, Auction auction, String bidderName, String message) {
        return new AuctionEvent(
                type,
                safeAuctionId(auction),
                safeItemId(auction),
