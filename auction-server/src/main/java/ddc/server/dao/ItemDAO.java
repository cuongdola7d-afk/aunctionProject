...
public class ItemDAO {
    ...
    public boolean addItem(Item item) {
        String sql = "INSERT INTO ddc_items (id, item, category, description, seller) VALUES (?, ?, ?, ?, ?)";
    ...
    public Item getItem(String id) {
        ...
        try (Connection con = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                Item item = buildItemByCategory(category, itemName, description, seller);
                if (item != null) {
                    item.setId(itemId);
                }
                return item;
    ...
    private Item buildItemByCategory(String category, String itemName, String description, String sellerName) {
        if (category == null) {
            return null;
        }
